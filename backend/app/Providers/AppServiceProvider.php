...
use App\Infrastructure\IdentityAccess\Turnstile\CloudflareTurnstileVerifier;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(TurnstileVerifierInterface::class, CloudflareTurnstileVerifier::class);
